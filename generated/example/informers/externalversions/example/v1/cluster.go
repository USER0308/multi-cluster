...
import (
	...
	examplev1 "example.org/multi-clusters/api/example/v1"
	versioned "example.org/multi-clusters/generated/example/clientset/versioned"
	internalinterfaces "example.org/multi-clusters/generated/example/informers/externalversions/internalinterfaces"
	v1 "example.org/multi-clusters/generated/example/listers/example/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.ExampleV1().Clusters(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ExampleV1().Clusters(namespace).Watch(context.TODO(), options)
			},
		},
		&examplev1.Cluster{},
		resyncPeriod,
...
func (f *clusterInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&examplev1.Cluster{}, f.defaultInformer)
}
